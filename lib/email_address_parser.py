# your code goes here!from email_address_parser import EmailAddressParser
...
class TestEmailAddressParser:
    ...
    def test_parses_emails_with_commas(self):
        ...
        parser = EmailAddressParser("talk@talk.com,john.jones@flatironschool.com,alexa@amazon.com")
        assert(sorted(parser.parse()) == sorted(["alexa@amazon.com", "john.jones@flatironschool.com", "talk@talk.com"]))
